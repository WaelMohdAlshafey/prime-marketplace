...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen bg-[#F8F9FA] overflow-x-hidden">
            {/* Mobile hamburger – fixed position, always visible */}
            <button
            ...
            {/* Sidebar – fixed, with proper scrolling and width */}
            <aside
            ...
            {/* Main content – with proper padding and overflow protection */}
            <main className="flex-1 p-4 md:p-8 overflow-x-hidden max-w-[calc(100vw-1rem)] lg:max-w-full pt-16 lg:pt-8">
                {children}
            </main>
        </div>
    );
