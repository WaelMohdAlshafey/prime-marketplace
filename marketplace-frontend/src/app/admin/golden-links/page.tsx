...
const REDIRECT_OPTIONS = [
    ...
    { label: 'Dashboard (Vendor)', value: '/vendor/dashboard' },
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Redirect User To</label>
                    <select
                        value={redirectPath}
                    ...
                    <p className="text-xs text-gray-400 mt-1">Where the user will be redirected after signing in.</p>
                </div>
                ...
                {link && (
                    <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            ⚠️ Multiple uses until expiry.<br />
                            User will be redirected to: <strong>{redirectPath}</strong>
                        </p>
                    </div>
                )}
            </div>
