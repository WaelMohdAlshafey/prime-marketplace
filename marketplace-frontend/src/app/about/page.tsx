...
export default function About() {
    ...
    if (loading) {
        return <div className="text-center py-12">{t('aboutLoading')}</div>;
    }

    if (!settings) {
        return <div className="text-center py-12">{t('aboutError')}</div>;
    }

    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center">
                {t('aboutTitle', { storeName: settings.storeName })}
            </h1>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 space-y-6">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('aboutOwners')}</h3>
                ...
                <div>
                    <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('aboutMobileNumbers')}</h3>
                ...
                <div>
                    <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('aboutEmails')}</h3>
                    <ul className="space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                        ...
                        <p className="text-gray-600 font-mono">{settings.}</p>
                    </div>
                </div>

                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mt-4">
                    <p className="text-sm text-blue-800">{t('aboutCustomerService')}</p>
                </div>
            </div>
        </div>
    );
